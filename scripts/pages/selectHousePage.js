...
const SelectHousePageDesign = require('ui/ui_selectHousePage');
...
const SelectHousePage = extend(SelectHousePageDesign)(
  // Constructor
  function(_super) {
...
function onShow(superOnShow) {
  ...
  var listView = this.children.lvHouses;
...
module && (module.exports = SelectHousePage);