...
const FlockDataPageDesign   = require('ui/ui_flockDataPage');
...
const FlockDataPage = extend(FlockDataPageDesign)(
  // Constructor
  function(_super) {
...
function onShow(superOnShow) {
  ...
  var listView = this.children.lvFlockData;
...
module && (module.exports = FlockDataPage);